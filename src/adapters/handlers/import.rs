//! Import handlers for CSV upload of all entity types and bibitems.
//!
...
#[derive(Debug, Serialize)]
struct MissingReferencesError {
    error: &'static str,
    message: &'static str,
    #[serde(skip_serializing_if = "Vec::is_empty")]
    missing_author_ids: Vec<i64>,
    #[serde(skip_serializing_if = "Vec::is_empty")]
    missing_journal_ids: Vec<i64>,
    #[serde(skip_serializing_if = "Vec::is_empty")]
    missing_publisher_ids: Vec<i64>,
    #[serde(skip_serializing_if = "Vec::is_empty")]
    missing_institution_ids: Vec<i64>,
    #[serde(skip_serializing_if = "Vec::is_empty")]
    missing_school_ids: Vec<i64>,
    #[serde(skip_serializing_if = "Vec::is_empty")]
    missing_series_ids: Vec<i64>,
    #[serde(skip_serializing_if = "Vec::is_empty")]
    missing_keyword_ids: Vec<i64>,
    #[serde(skip_serializing_if = "Vec::is_empty")]
    missing_crossref_ids: Vec<i64>,
}
...
pub async fn import_bibitems(
    ...
    if missing.has_missing() {
        return Ok((StatusCode::UNPROCESSABLE_ENTITY, Json(missing)).into_response());
    }
